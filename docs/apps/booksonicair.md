...
[![Compose Templates](https://img.shields.io/static/v1?style=flat-square&color=607D8B&label=compose&message=templates)](https://github.com/GhostWriters/DockSTARTer-Templates/tree/main/.apps/booksonic-air)

## Description

[Booksonic Air](https://booksonic.org/) is a server and an app for streaming your
